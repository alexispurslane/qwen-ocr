...
class Config:
    ...
    def _initialize(self):
        ...
        self.MODEL_NAME = os.environ.get(
            "SYNTHETIC_MODEL_NAME", "hf:Qwen/Qwen3-VL-235B-A22B-Instruct"
        )
        self.API_KEY = os.environ.get("SYNTHETIC_API_KEY")
        if not self.API_KEY:
            raise ValueError(
                "SYNTHETIC_API_KEY environment variable is not set. "
                "Please set it with: export SYNTHETIC_API_KEY='your-api-key'"
            )
